...
public class FavRecyclerViewAdapter extends RecyclerView.Adapter<FavRecyclerViewAdapter.FavFragmaentViewHolder> implements ExoPlayer.EventListener {
    ...
    public FavRecyclerViewAdapter(String[] data) {
        this.data = data;
    ...
    @NonNull
    @Override
    public FavRecyclerViewAdapter.FavFragmaentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_ui_2,parent,false);
        this.player = ExoPlayerFactory.newSimpleInstance(parent.getContext());
        this.context = parent.getContext();
        FavRecyclerViewAdapter.FavFragmaentViewHolder vh = new FavRecyclerViewAdapter.FavFragmaentViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final FavRecyclerViewAdapter.FavFragmaentViewHolder holder, int position) {
...
// Prepare the player with the source.
    ...
    public static class FavFragmaentViewHolder extends RecyclerView.ViewHolder{
...
//        View mVideoLayout;
        ...
        public FavFragmaentViewHolder(@NonNull View itemView) {
            super(itemView);
